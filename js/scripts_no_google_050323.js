    ...
    var homicideChart = c3.generate({
        ...
        data: {
            ...
            colors: {
                ...
                '2020': '#bbb',
                '2021': '#bbb',
                '2022': 'rgba(142,16,36,.5)',
                '2023': 'rgba(142,16,36,1)'
            }
        },
        grid: {
            x: {
...
var homicideRateChart = c3.generate({
    ...
    data: {
        ...
        columns: [
            ...
            ['Homicide count', 99, 100, 68, 78, 82, 72, 91, 79, 69, 55, 67, 89, 93, 73, 85, 82, 69, 72, 55, 65, 33, 47, 51, 65, 91, 61, 55, 50, 49, 38, 37, 44, 39, 42, 31, 50, 56, 56, 67, 63, 95, 96, 88],
            ['Homicide rate', 20.1, 20.0, 13.5, 15.3, 16.2, 14.3, 18.2, 16.1, 14.4, 11.6, 14.3, 18.6, 18.8, 14.4, 16.6, 15.8, 13.1, 13.4, 10.2, 11.8, 5.9, 8.3, 9.1, 11.6, 16.3, 10.9, 9.7, 8.6, 8.3, 6.2, 6.1, 7.1, 6.1, 6.5, 4.7, 7.3, 8.0, 7.9, 9.4, 8.7, 12.9, 13.5, 12.4]
        ],
        types: {
            'Homicide count': 'line',
...
var map = L.map('map', {
    ...
    // touchZoom: true,
    keyboard: false,
    layers: [stamenMap, neighborhoods, homicides2023, homicides2022, homicides2021, homicides2020, homicides2019, homicides2018, homicides2017, homicides2016, homicides2015]
});
...
$.getJSON(dataFile, function(data) {
    ...
    for (i = 0; i < output.length; i++) {
        ...
        homicideCoordinates.features.push({
            ...
            'properties': {
                'homicideDate': output[i].homicideDate,
                'homicideYear': output[i].homicideYear,
                'victimName': output[i].victimName,
                'victimAge': output[i].victimAge,
                'blockAddress': output[i].blockAddress,
                'mannerOfDeath': output[i].mannerOfDeath,
                'articleLink': output[i].articleLink
            }
        });
    }
