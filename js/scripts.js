...
var homicideRateChart = c3.generate({
    ...
    data: {
        ...
        columns: [
            ...
            ['Homicide rate', 14.5, 18.3, 16.1, 14.4, 11.6, 14.3, 18.5, 19.5, 14.8, 16.1, 16.0, 12.3, 13.1, 9.6, 11.5, 5.7, 8.0, 9.1, 11.2, 15.5, 10.5, 9.1, 8.2, 6.9, 5.9, 4.6, 5.5, 6.1, 6.1, 4.7, 7.3, 8.0, 7.9, 9.3, 8.4]
        ],
        types: {
            'Homicide count': 'line',
