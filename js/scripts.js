...
var dataFile = "js/homicides-020720.json";
...
var homicideRateChart = c3.generate({
    ...
    data: {
        ...
        columns: [
            ...
            ['Homicide count', 72, 91, 79, 69, 55, 67, 88, 95, 74, 81, 81, 64, 69, 51, 63, 32, 45, 51, 63, 87, 59, 51, 47, 40, 35, 28, 34, 39, 40, 31, 50, 56, 56, 67, 63],
            ['Homicide rate', 14.5, 18.3, 16.1, 14.4, 11.6, 14.3, 18.5, 19.5, 14.8, 16.1, 16.0, 12.3, 13.1, 9.6, 11.5, 5.7, 8.0, 9.1, 11.2, 15.5, 10.5, 9.1, 8.2, 6.9, 5.9, 4.6, 5.5, 6.1, 6.1, 4.7, 7.3, 8.0, 7.9, 9.3, 8.6]
        ],
        types: {
            'Homicide count': 'line',
